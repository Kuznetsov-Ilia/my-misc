...
function isUndefined(value) {
  return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === undefined;
}
...
function strip_tags(str) {
  if ((typeof stripTagsRegExp === 'undefined' ? 'undefined' : _typeof(stripTagsRegExp)) === undefined) {
    stripTagsRegExp = /<\/?[^>]+>/gi;
  }
...
function viaSendBeacon(url, data) {
  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object') {
    ...
    setTimeout(function () {
      return navigator.sendBeacon(url, realData);
    }, 0);
  }
}
...
function viaImg(url, data) {
  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object') {
    ...
    setTimeout(function () {
      return img.src = uri.substr(0, 2000);
    }, 0);
  }
}
...
function scriptify(HTMLElement) {
  ...
  var external_scripts = scripts.filter(function (script) {
    return script.src !== '';
  });
  var internal_scripts = scripts.filter(function (script) {
    return script.src === '';
  });
  external_scripts.forEach(function (script) {
